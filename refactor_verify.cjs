...
// 1. Remove the twoDaysAgoStr and local prev day variables.
...
// 2. Replace variables in exportProductsList
...
// 3. Revert warehouseStockIns loop
...
// 4. Update managedTransactions loop
...
// 5. Update verifyOpeningStock calculation
...
console.log('Math refactored successfully');
