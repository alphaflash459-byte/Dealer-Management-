...
const targetStr = `                      <tr className="text-slate-400 text-[9px] sm:text-[10px] md:text-xs uppercase font-bold tracking-wider border-b border-slate-100 text-center">
...
if (content.includes(targetStr)) {
  ...
  console.log("Success update user dashboard table ui");
} else {
  console.log("Target not found user dashboard table ui");
}
