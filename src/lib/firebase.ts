...
import { initializeFirestore, collection, addDoc, getDocs, updateDoc, deleteDoc, doc, query, onSnapshot, setDoc } from 'firebase/firestore';
...
// Initialize Firestore specifying the databaseId generated by AI Studio with long-polling
export const db = initializeFirestore(app, {
  experimentalForceLongPolling: true,
}, "ai-studio-dealermanagement-28b906f6-ad4c-4671-9db2-d50a4c81d966");
