                        ...
                        {orderItems.map((item, index) => {
                          ...
                          return (
                            <div key={index} className="grid grid-cols-12 gap-2 py-2 items-center px-2 hover:bg-slate-50 rounded-lg transition animate-in fade-in duration-150">
                              ...
                              {/* Deleted the Price block that was here before, skipping right to Delete button */}`;

const restoredString = content.substring(0, startIndex) + newContent + content.substring(endIndex + "                              {/* Price / Subtotal */}".length);
