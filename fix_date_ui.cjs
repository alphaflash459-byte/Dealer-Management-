...
const badCode = `        <div className="bg-slate-50 p-3.5 rounded-2xl mb-4 border border-slate-100 flex flex-col sm:flex-row sm:items-end gap-3 shrink-0">
...
const goodCode = `        {activeTab !== 'Stock Order' && (
...
console.log('Fixed date UI logic!');
