...
const targetToReplace = fs.readFileSync('target_user.txt', 'utf8').trimEnd(); // remove trailing newline
...
if (content.includes(targetToReplace)) {
  ...
  console.log("Successfully replaced layout in UserDashboard.tsx");
} else {
